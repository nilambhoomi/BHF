...
public partial class PatientListDetail : System.Web.UI.Page
{
    ...
    public static string UpdatePrintStatus(string flag, long id)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string CheckDownload(string flag, long id)
    {
        string tempFileName = DateTime.Now.ToString("yyyyMMdd_") + flag + "_" + id;
        string tempFilePath = ConfigurationSettings.AppSettings["downloadpath"].ToString();
        string fileGetPath = ConfigurationSettings.AppSettings["fileGetPath"].ToString();
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string UpdatePrintStatusRod(string flag, long id)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string CheckDownloadRod(string flag, long id)
    {
        string tempFileName = "_" + id + "_" + flag + "_Rod";
        string tempFilePath = ConfigurationSettings.AppSettings["downloadpath"].ToString();
    ...
    protected void btnrodsave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                Text = "RoD",
                CommandArgument = _fufuid + "-" + _fuieid
            };
    ...
    private string bindRodPrintvalue()
    {
        ...
        foreach (string item in bodypartselected.TrimEnd(',').Split(','))
        {
            for (int i = 0; i < repRoD.Items.Count; i++)
            {
        ...
        foreach (string v in bodypart.Split(','))
        {
            for (int i = 0; i < repRoD.Items.Count; i++)
            {
                TextBox txt1 = i == 0 || i == 13 || i == 15 ? repRoD.Items[i].FindControl("txtRod") as TextBox : repRoD.Items[i].FindControl("txtRod1") as TextBox;
    ...
    protected void lnkierod_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                RowFilter = "PatientIE_ID=" + Convert.ToInt32(btn.CommandArgument) // query example = "id = 10"
            };
            ...
            ClientScript.RegisterStartupScript(GetType(), "Popup", "openModelPopup();", true);
        }
        catch (Exception)
        {
            throw;
    ...
    protected void lnkfurod_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataView dv = new DataView(dt)
            {
                RowFilter = "PatientFUId=" + Convert.ToInt32(hdnrodeditedfuid.Value) // query example = "id = 10"
            };
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString);
            DBHelperClass db = new DBHelperClass();
    ...
    protected void lnkprint_Click(object sender, EventArgs e)
    {
        ...
        string lstnote = getLastNote(ds.Tables[0].Rows[0]["Compensation"].ToString());
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            treatment = getTreatment(ds.Tables[0].Rows[0]["TreatMentDelimit"].ToString());
        }
        ...
        string strRos = "", strRosDenis = "", strComplain = "", strRestriction = "", strWorkStatus = "", strMedi = "";
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            page2 = new PrintDocumentHelper().getPage1String(ds.Tables[0].Rows[0]["activityEffectedHTML"].ToString());

            string strADL = getADLString(page2);

            if (!string.IsNullOrEmpty(strADL))
            {
                strADL = "Patient's ability to perform activities of daily living," + strADL;
                str = str.Replace("#ADL", "<b>ACTIVITIES OF DAILY LIVING AFFECTED: </b><br/>" + strADL + "<br/><br/>");
            }
            else
            {
                str = str.Replace("#ADL", "");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                strExceptions = FirstCharToUpper(strExceptions.TrimStart());
            ...
            strExceptions = FirstCharToUpper(strExceptions);
            ...
            if (!string.IsNullOrEmpty(senexam))
            {
                senexam = FirstCharToUpper(senexam.TrimStart());
...
if (page3_1.ContainsKey("txtMST"))
        ...
        strDaigNeck = getDiagnosis("Neck", lnk.CommandArgument);
        strDaigMid = getDiagnosis("Midback", lnk.CommandArgument);
        strDaigLow = getDiagnosis("Lowback", lnk.CommandArgument);
        strDiagOther = getDiagnosis("Other", lnk.CommandArgument);
        strDaigRL = getDiagnosisRightLeft(lnk.CommandArgument);
        ...
        string strPlan = "";
        if (!string.IsNullOrEmpty(getPOC("Neck", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Neck", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpNeck", lnk.CommandArgument)) == false ? getPlan("tblbpNeck", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("MidBack", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("MidBack", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpMidback", lnk.CommandArgument)) == false ? getPlan("tblbpMidback", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("LowBack", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("LowBack", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpLowback", lnk.CommandArgument)) == false ? getPlan("tblbpLowback", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Shoulder", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Shoulder", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpShoulder", lnk.CommandArgument)) == false ? getPlan("tblbpShoulder", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Knee", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Knee", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpKnee", lnk.CommandArgument)) == false ? getPlan("tblbpKnee", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Elbow", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Elbow", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpElbow", lnk.CommandArgument)) == false ? getPlan("tblbpElbow", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Wrist", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Wrist", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpWrist", lnk.CommandArgument)) == false ? getPlan("tblbpWrist", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Hip", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
            strPlan = strPlan + getPOC("Hip", lnk.CommandArgument);
        }

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpHip", lnk.CommandArgument)) == false ? getPlan("tblbpHip", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Ankle", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Ankle", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpAnkle", lnk.CommandArgument)) == false ? getPlan("tblbpAnkle", lnk.CommandArgument) : "");

        if (!string.IsNullOrEmpty(getPOC("Other", lnk.CommandArgument)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOC("Other", lnk.CommandArgument);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlan("tblbpOtherPart", lnk.CommandArgument)) == false ? getPlan("tblbpOtherPart", lnk.CommandArgument) + "<br/><br/>" : "");
        ...
        ccplandesc = getCCPlan("Neck", lnk.CommandArgument);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                string romstrleft = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["LeftROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "left", "IE", "Neck");

                string romstrright = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["RightROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "right", "IE", "Neck");
                string romstrC = getROMString(ds.Tables[0].Rows[0]["CNameROM"].ToString(), ds.Tables[0].Rows[0]["CROM"].ToString(), ds.Tables[0].Rows[0]["CNormalROM"].ToString(), "", "IE");
                string romstr = romstrleft.Replace(".", ";") + " " + romstrright;

                string finalrom = "";
                if (!string.IsNullOrEmpty(romstrC))
                {
                    romstrC = FirstCharToUpper(romstrC.TrimStart());
                ...
                if (!string.IsNullOrEmpty(romstr) && romstr != " ")
                {
                    if (string.IsNullOrEmpty(romstrC))
                    {
                        romstr = FirstCharToUpper(romstr.TrimStart());
                ...
                {
                    neckPE = neckPE.Replace("#romneck", formatString(finalrom));
                }
                else
                {
        ...
        ccplandesc = getCCPlan("Lowback", lnk.CommandArgument);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["NameROM"].ToString()))
            {
                string romstrleft = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["LeftROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "left", "IE", "Lowback");
                string romstrright = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["RightROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "right", "IE", "Lowback");
                string romstrC = getROMString(ds.Tables[0].Rows[0]["CNameROM"].ToString(), ds.Tables[0].Rows[0]["CROM"].ToString(), ds.Tables[0].Rows[0]["CNormalROM"].ToString(), "", "IE");
                string romstr = romstrleft.Replace(".", ";") + " " + romstrright;
        ...
        ccplandesc = getCCPlan("Midback", lnk.CommandArgument);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["PEvalue"].ToString()))
            {
                ...
                midbackTP = getTPString(ds.Tables[0].Rows[0]["PESides"].ToString(), ds.Tables[0].Rows[0]["PESidesText"].ToString());
        ...
        ccplandesc = getCCPlan("Shoulder", lnk.CommandArgument);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                string romstr = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["LeftROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "left");
            ...
            {
                string romstr = getROMString(ds.Tables[0].Rows[0]["NameROM"].ToString(), ds.Tables[0].Rows[0]["RightROM"].ToString(), ds.Tables[0].Rows[0]["NormalROM"].ToString(), "right");
                if (!string.IsNullOrEmpty(romstr))
                {
                    romstr = FirstCharToUpper(romstr.TrimStart());
        ...
        ccplandesc = getCCPlan("Knee", lnk.CommandArgument);
        ...
        ccplandesc = getCCPlan("Elbow", lnk.CommandArgument);
        ...
        ccplandesc = getCCPlan("Wrist", lnk.CommandArgument);
        ...
        ccplandesc = getCCPlan("Hip", lnk.CommandArgument);
        ...
        ccplandesc = getCCPlan("Ankle", lnk.CommandArgument);
        ...
        docname = System.Text.RegularExpressions.Regex.Replace(docname.Replace("\t", " "), reduceMultiSpace, " ");
        ...
        //BindPatientIEDetails();
        ClientScript.RegisterStartupScript(GetType(), "Popup", "alert('Documents will be available for download after 5 min.')", true);
        //}
        //catch (Exception ex)
        //{
        //}
    ...
    protected void lnkprintFU_Click(object sender, EventArgs e)
    {
        ...
        string strOldHistory = getoldHistory(ds.Tables[0].Rows[0]["Patient_ID"].ToString());
        ...
        query = ("select topSectionHTML,degreeSectionHTML,activityEffectedHTML from tblPage1FUHTMLContent where PateintFU_ID= " + PatientFU_ID + "");
        ds = db.selectData(query);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            //ADL Printing
            page1 = new PrintDocumentHelper().getPage1String(ds.Tables[0].Rows[0]["activityEffectedHTML"].ToString());

            string strADL = getADLString(page1);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            treatment = getTreatment(ds.Tables[0].Rows[0]["RecommandationDelimit"].ToString());
        }
        ...
        if (!string.IsNullOrEmpty(getPOCFU("Neck", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Neck", PatientIE_ID, PatientFU_ID);

        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpNeck", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpNeck", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("MidBack", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("MidBack", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpMidback", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpMidback", PatientFU_ID) : "");


        if (!string.IsNullOrEmpty(getPOCFU("LowBack", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("LowBack", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpLowback", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpLowback", PatientFU_ID) : "");


        if (!string.IsNullOrEmpty(getPOCFU("Shoulder", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Shoulder", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpShoulder", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpShoulder", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Knee", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Knee", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpKnee", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpKnee", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Elbow", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Elbow", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpElbow", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpElbow", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Wrist", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Wrist", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpWrist", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpWrist", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Hip", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Hip", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpHip", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpHip", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Ankle", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Ankle", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpAnkle", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpAnkle", PatientFU_ID) : "");

        if (!string.IsNullOrEmpty(getPOCFU("Other", PatientIE_ID, PatientFU_ID)))
        {
            strPlan = strPlan + "<br/>";
        }

        strPlan = strPlan + getPOCFU("Other", PatientIE_ID, PatientFU_ID);
        strPlan = strPlan + (string.IsNullOrEmpty(getPlanFU("tblFUbpOtherPart", PatientFU_ID)) == false ? "<br />" + getPlanFU("tblFUbpOtherPart", PatientFU_ID) : "");
        ...
        strDaigNeck = getDiagnosis("Neck", "0", PatientFU_ID);
        strDaigMid = getDiagnosis("Midback", "0", PatientFU_ID);
        strDaigLow = getDiagnosis("Lowback", "0", PatientFU_ID);
        strDaigOther = getDiagnosis("Other", "0", PatientFU_ID);
        strDaigRL = getDiagnosisRightLeft("0", PatientFU_ID);
        ...
        ccplandesc = getCCPlan("Neck", "0", PatientFU_ID);
        str = str.Replace("#ccplandescneck", ccplandesc);
        ...
        ccplandesc = getCCPlan("Lowback", "0", PatientFU_ID);
        str = str.Replace("#ccplandesclowback", ccplandesc);
        ...
        ccplandesc = getCCPlan("Midback", "0", PatientFU_ID);
        str = str.Replace("#ccplandescmidback", ccplandesc);
        ...
        ccplandesc = getCCPlan("Knee", "0", PatientFU_ID);
        str = str.Replace("#ccplandescshoulder", ccplandesc);
        ...
        ccplandesc = getCCPlan("Elbow", "0", PatientFU_ID);
        str = str.Replace("#ccplandescelbow", ccplandesc);
        ...
        ccplandesc = getCCPlan("Wrist", "0", PatientFU_ID);
        str = str.Replace("#ccplandescwrist", ccplandesc);
        ...
        ccplandesc = getCCPlan("Hip", "0", PatientFU_ID);
        str = str.Replace("#ccplandeschip", ccplandesc);
        ...
        ccplandesc = getCCPlan("Ankle", "0", PatientFU_ID);
        str = str.Replace("#ccplandescankle", ccplandesc);
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#otherPE", !string.IsNullOrEmpty(ds.Tables[0].Rows[0]["OthersPE"].ToString()) ? ds.Tables[0].Rows[0]["OthersPE"].ToString() : "");
...
,p.Level,p.Muscle,p.Sides
    ...
    private void generatePNReport(string bodyPart, string MCODE, string patientName, string DOB, string location, string Muscle, string levels, string Medications, string C34, string examdate, string PatientIE_ID = "", string PatientFU_ID = "")
    {
        ...
        {
            string filePath = path + "/" + MCODE + ".dotx";
            ...
            doc.SaveAs2(newfile);
            if (doc.Bookmarks.Exists("DOB"))
            {
                editBookmark(doc, "DOB", DOB);
            }

            if (doc.Bookmarks.Exists("Medications"))
            {
                editBookmark(doc, "Medications", Medications);
            }

            if (doc.Bookmarks.Exists("C34"))
            {
                editBookmark(doc, "C34", C34);
            }

            if (doc.Bookmarks.Exists("examdate"))
            {
                editBookmark(doc, "examdate", examdate);
            }

            if (doc.Bookmarks.Exists("Levels"))
            {
                editBookmark(doc, "Levels", levels);
            }

            if (doc.Bookmarks.Exists("lic"))
            {
                editBookmark(doc, "lic", "lic");
            }

            if (doc.Bookmarks.Exists("locperformed"))
            {
                editBookmark(doc, "locperformed", location);
            }

            if (doc.Bookmarks.Exists("Muscle"))
            {
                editBookmark(doc, "Muscle", Muscle);
            }

            if (doc.Bookmarks.Exists("pname"))
            {
                editBookmark(doc, "pname", patientName);
            }
    ...
    protected void DownloadFiles(string folderPath, string fullname, string IEFU)
    {
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "Popup", "alert('Documents will be available soon.')", true);
        }
    }
    ...
    protected void btnSaveSign_Click(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(hidBlobServer.Value) == false)
        {
            try
            {
                ...
                ClientScript.RegisterStartupScript(GetType(), "Popup", "closeSignModelPopup();", true);
    ...
    protected void lnkSignFU_Click(object sender, EventArgs e)
    {
        ...
        ClientScript.RegisterStartupScript(GetType(), "PopupFU", "openSignModelPopup(0," + lnk.CommandArgument + ",'" + flag + "','" + filename + "');", true);
    }
    ...
    protected void lnkSignIE_Click(object sender, EventArgs e)
    {
        ...
        ClientScript.RegisterStartupScript(GetType(), "PopupIE", "openSignModelPopup(" + str[0] + ",0,'" + flag + "','" + filename + "');", true);
    }
    ...
    protected void lnkuploadsign_Click(object sender, EventArgs e)
    {
        ...
        ClientScript.RegisterStartupScript(GetType(), "PopupIE", "opensignupload(" + lnk.CommandArgument + ",0,'" + flag + "','" + filename + "');", true);
    }
    ...
    protected void btnuploadimage_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ClientScript.RegisterStartupScript(GetType(), "Popup", "closeSignuploadModalPopup();", true);
        }
        catch (Exception)
        {
        }
    ...
    protected void lnkPONReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "AlertPopup", "javascript:alert('Please Add Report first from OtherPart menu.')", true);
            }
        }
        catch (Exception)
        {
    ...
    private string getBodyPartswithnumber(string patientIEID, string casetype, string doa)
    {
        ...
        long ieId = Convert.ToInt64(patientIEID);
    ...
    private string getADLString(Dictionary<string, string> page2)
    {
        string strADL = "";

        if (page2.Count > 0)
        {
            if (page2["chkpersonalhygiene"] == "true")
            {
                strADL += "<br/>Personal hygiene, grooming, dressing, toileting";

                if (page2["rblPerform1"] == "true")
                {
                    strADL += "- able to perform";
                }
                else if (page2["rblPerform11"] == "true")
                {
                    strADL += "- cannot perform";
                }

                if (!string.IsNullOrEmpty(page2["txtWithDifficulty1"]))
                {
                    strADL += " " + page2["txtWithDifficulty1"].TrimEnd('.');
                }
            ...
            if (page2["chkwalking"] == "true")
            {
                strADL += "<br/>Walking, transferring, ambulating";

                if (page2["rblPerform2"] == "true")
                {
                    strADL += "- able to perform";
                }
                else if (page2["rblPerform22"] == "true")
                {
                    strADL += "- cannot perform";
                }

                if (!string.IsNullOrEmpty(page2["txtWithDifficulty2"]))
                {
                    strADL += " " + page2["txtWithDifficulty2"].TrimEnd('.');
                }
            ...
            if (page2["chkeatingindependently"] == "true")
            {
                strADL += "<br/>Eating independently";

                if (page2["rblPerform3"] == "true")
                {
                    strADL += "- able to perform";
                }
                else if (page2["rblPerform33"] == "true")
                {
                    strADL += "- cannot perform";
                }

                if (!string.IsNullOrEmpty(page2["txtWithDifficulty3"]))
                {
                    strADL += " " + page2["txtWithDifficulty3"].TrimEnd('.');
                }
            ...
            if (page2["chkcook"] == "true")
            {
                strADL += "<br/>Cook, clean, maintain households";

                if (page2["rblPerform4"] == "true")
                {
                    strADL += "- able to perform";
                }
                else if (page2["rblPerform44"] == "true")
                {
                    strADL += "- cannot perform";
                }

                if (!string.IsNullOrEmpty(page2["txtWithDifficulty4"]))
                {
                    strADL += " " + page2["txtWithDifficulty4"].TrimEnd('.');
                }
            ...
            if (page2["chkshop"] == "true")
            {
                strADL += "<br/>Shop for food";

                if (page2["rblPerform5"] == "true")
                {
                    strADL += "- able to perform";
                }
                else if (page2["rblPerform55"] == "true")
                {
                    strADL += "- cannot perform";
                }

                if (!string.IsNullOrEmpty(page2["txtWithDifficulty5"]))
                {
                    strADL += " " + page2["txtWithDifficulty5"].TrimEnd('.');
                }
            ...
            if (page2["chkSleeping"] == "true")
            {
                strADL += "<br/>Sleeping -";



                if (!string.IsNullOrEmpty(page2["txtWithDifficulty6"]))
                {
                    strADL += " " + page2["txtWithDifficulty6"].TrimEnd('.');
                }
    ...
    {
        LinkButton lnkclone = sender as LinkButton;

        string Patient_ID = Convert.ToString(lnkclone.CommandArgument).Split('~')[0];
        string PatientIE_ID = Convert.ToString(lnkclone.CommandArgument).Split('~')[1];

        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString))
        {
            SqlCommand cmd = new SqlCommand("CloneRecord", con);
