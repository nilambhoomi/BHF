...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        $(document).ready(function ($) {
            ...
            $('#<%=txtSDate.ClientID%>').mask("99/99/9999");
        ...
        <div class="modal-dialog" style="background: white;">
            <div class="modal-content" style="height: 200px;">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="input-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="req1" ErrorMessage="Please select Date" ControlToValidate="txtSDate" ValidationGroup="sDate"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer" style="display: inline-block; width: 100%; text-align: center;">
                    <asp:Button ID="btnSave" CssClass="btn btn-info" runat="server" OnClick="btnSave_Click" Text="Save" ValidationGroup="sDate" />&nbsp;
