...
public partial class AddFU : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.QueryString["PID"] != null)
            {
                ...
                AddFollowUpMaster master = (AddFollowUpMaster)Master;
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString))
        {
            ...
            while (sdr.Read())
            {
                ...
                using (DataSet ds = new DataSet())
                {
                    ...
                    EnumerableRowCollection<DataRow> result = from dm in Store.AsEnumerable()
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString))
            {
                ...
                //    cmd.Parameters.Add("@isEditFU", true);
                //}
                cmd.Parameters.Add("@isEditFU", false);
    ...
    {
        SaveData(); List<BodyParts> s = (List<BodyParts>)Session["FUbodyPartsList"];
        if (s != null)
        {

            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "RightShoulder" && i.Checked == true select i).ToList();
            ...
            else
            {
                ...
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpShoulder");
            }
        ...
        else
        {
            ...
            AddFollowUpMaster master = (AddFollowUpMaster)Master; master.bindData(hfPatientFUId.Value);
    ...
    protected void chk_L_Shoulder_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftShoulder" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpShoulder");
            }
            Session["FUbodyPartsList"] = s;
            AddFollowUpMaster master = (AddFollowUpMaster)Master; master.bindData(hfPatientFUId.Value);
        }
    ...
    protected void chk_Neck_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "Neck" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            if (chk_Neck.Checked)
            {
                if (count == 0)
    ...
    protected void chk_Midback_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "MidBack" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
    ...
    protected void chk_lowback_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LowBack" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
    ...
    protected void chk_r_Keen_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where (i.Parts == "RightKnee" && i.Checked == true) select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_r_Keen = false;
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpKnee");
            }
            Session["FUbodyPartsList"] = s;
            AddFollowUpMaster master = (AddFollowUpMaster)Master; master.bindData(hfPatientFUId.Value);
        }
    ...
    protected void chk_L_Keen_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            ...
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftKnee" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_L_Keen = true;
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpKnee");
            }
    ...
    protected void chk_r_Elbow_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "RightElbow" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_r_Elbow = false;
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpElbow");
            }
    ...
    protected void chk_l_Elbow_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftElbow" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_l_Elbow = true;
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpElbow");
            }
    ...
    protected void chk_r_Wrist_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "RightWrist" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_r_Wrist = false;
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpWrist");
            }
    ...
    protected void chk_l_Wrist_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftWrist" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_l_Wrist = true;
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpWrist");
            }
            Session["FUbodyPartsList"] = s;
            AddFollowUpMaster master = (AddFollowUpMaster)Master; master.bindData(hfPatientFUId.Value);
        }
    ...
    protected void chk_r_Hip_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "RightHip" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_r_Hip = false;
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpHip");
            }
    ...
    protected void chk_l_Hip_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftHip" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_l_Hip = false;
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpHip");
            }
            Session["FUbodyPartsList"] = s;
            AddFollowUpMaster master = (AddFollowUpMaster)Master; master.bindData(hfPatientFUId.Value);
        }
    ...
    protected void chk_r_ankle_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "RightAnkle" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_r_ankle = false;
                removeROM("rightNormal", hfPatientFUId.Value, "tblFUbpAnkle");
            }
            Session["FUbodyPartsList"] = s;
    ...
    protected void chk_l_ankle_CheckedChanged(object sender, EventArgs e)
    {
        ...
        SaveData();
        List<BodyParts> s = (List<BodyParts>)Session["FUbodyPartsList"];
        if (s != null)
        {
            List<BodyParts> cnt = (from i in s.AsEnumerable() where i.Parts == "LeftAnkle" && i.Checked == true select i).ToList();
            if (cnt == null) { count = 0; } else { count = cnt.Count(); }
            ...
            else
            {
                ...
                Chk_l_ankle = false;
                removeROM("leftNormal", hfPatientFUId.Value, "tblFUbpAnkle");
            }
            Session["FUbodyPartsList"] = s;
            AddFollowUpMaster master = (AddFollowUpMaster)Master;
            master.bindData(hfPatientFUId.Value);
    ...
    public int GetFUID(long PatientIE_Id)
    {
        ...
        {
            new SqlParameter("@PatientIE_Id", PatientIE_Id)
        };
        DataTable _dt = _dal.getDataTable("GetFUID", param);
        object data = _dt.Rows[0]["PatientFU_ID"];
    ...
    public void bindHtml()
    {
        ...
        if (_fuID == 0)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["activityEffectedHTML"].ToString()))
        ...
        {
            string query = "select top 1 activityEffectedHTML,topSectionHTML,activityEffectedHTML from tblPage1FUHTMLContent where PateintFU_ID=" + _fuID;
            DataSet ds = db.selectData(query);
    ...
    public void bindADLHTML()
    {
        string path = Server.MapPath("~/Template/Page2_activity_affected.html");
        string body = File.ReadAllText(path);
        divactivityeffected.InnerHtml = body;
    }

    public void bindTopHTML()
    {
        string path = Server.MapPath("~/Template/Page1_top.html");
        string body = File.ReadAllText(path);
        divHistory.InnerHtml = body;
    }
