    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                query = query + " '" + txtFirstName.Text + "','" + txtLastName.Text + "','" + txtMiddleName.Text + "','" + txtEmail.Text + "',Null,'admin',GETDATE()," + ddlDesig.SelectedItem.Value + "," + ddlGroup.SelectedItem.Value + ",'BHFPC','" + txtAddress.Text + "','" + txtPhoneNo.Text + "','" + ddlDesig.SelectedItem.Text + "') ";
            }
