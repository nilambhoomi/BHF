<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PstLstlstvst.aspx.cs" Inherits="PstLstlstvst" %>
        ...
        <div class="page-content">
            ...
            <asp:GridView ID="gvProcedureTbl" AllowSorting="true" OnSorting="gridView_Sorting" runat="server" Width="100%" AutoGenerateColumns="false" PageSize="100" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" PagerStyle-CssClass="pager">
                <Columns>
                    ...
                    <asp:BoundField DataField="ClaimNumber" HeaderText="ClaimNumber"/>

                    <asp:BoundField DataField="Phone" HeaderText="Phone"/>
                    <asp:BoundField DataField="Phone2" HeaderText="Phone2"/>
                    <asp:BoundField DataField="Attorney" HeaderText="Attorney"/>
                    <asp:BoundField DataField="attytelephone" HeaderText="attytelephone"/>
                </Columns>
