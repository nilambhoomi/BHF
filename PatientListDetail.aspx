<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PatientListDetail.aspx.cs" Inherits="PatientListDetail" %>
                                        ...
                                        <Columns>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton runat="server" ID="lnkFUDelete" OnClientClick="return confirm('Are you sure you want to delete this FU ?')" CssClass="btn btn-link" CommandArgument='<%# Eval("PatientFUId").ToString()%>' Visible="true" OnClick="lnkDelete_FU_Click">| Delete</asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lnkclone" runat="server" CommandArgument='<%# Eval("Patient_ID")+"~"+Eval("PatientIE_ID") %>' OnClick="lnkclone_Click" Text=" | Clone"></asp:LinkButton>
