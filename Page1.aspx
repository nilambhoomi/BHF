           ...
           <%-- $j('#<%=PatientIntime.ClientID%>').datepicker({
            ...
            $('[id*=txt_ins_co]').typeahead({
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data.d, function (i, item) {
                                var id = item.split('-')[1];
                                var name = item.split('-')[0];
                                var add = item.split('-')[2];
                                var phone = item.split('-')[3];
                                map[name] = { id: id, name: name, address: add, phone: phone };
                                items.push(name);
                            });
                            response(items);
                            $(".dropdown-menu").css("height", "auto");
                ...
                updater: function (item) {
                    ...
                    $('[id*=txt_ins_address]').val(map[item].address);
                    $('[id*=txt_ins_phone]').val(map[item].phone);
            ...
            function EndRequestHandler(sender, args) {
                ...
                $('#<%=txt_attorney_ph.ClientID%>').mask("999-999-9999");
                $('#<%=txt_SSN.ClientID%>').mask("999-99-9999");
                $('#<%=txt_ins_phone.ClientID%>').mask("999-99-9999");
                $('#<%=txt_adjuster_no.ClientID%>').mask("999-999-9999");
        ...
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="control-group span3">
                    <label class="control-label">Address.: </label>
                    <div class="controls">
                        <asp:TextBox runat="server" ID="txt_ins_address" TextMode="MultiLine" Style="height: 50px" CssClass="capitalize" TabIndex="18"></asp:TextBox>
                    </div>
                </div>
                <div class="control-group span3">
                    <label class="control-label">Phone.: </label>
                    <div class="controls">
                        <asp:TextBox runat="server" ID="txt_ins_phone" placeholder="xxx-xx-xxxx" CssClass="capitalize" TabIndex="18"></asp:TextBox>
                    </div>
                </div>
